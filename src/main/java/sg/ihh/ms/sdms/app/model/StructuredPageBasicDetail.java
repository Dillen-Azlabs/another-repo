...
@JsonPropertyOrder({"uid", "languageCode", "pageTitleH1Display", "itemUrl", "mainImageUrl", "mainImageAltText", "heroHighlight", "overview", "summary", "socialSummary","metaTitle","metaDescription", "order", "publishFlag", "createdDt", "modifiedDt"})
public class StructuredPageBasicDetail extends BaseModel{
    ...
    public StructuredPageBasicDetail() {
        //Empty Constructor
    }

...
public class StructuredCampaignService extends BaseService {
    ...
    @RequestMapping(path = "structuredCampaign/details", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "structuredCampaign/accordion", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "structuredCampaign/bodySections", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "structuredCampaign/faq", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "specialty/structuredCampaign", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "structuredCampaign/ctaSection", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "structuredCampaign/cta", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "condition/structuredCampaign", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(path = "treatment/structuredCampaign", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})

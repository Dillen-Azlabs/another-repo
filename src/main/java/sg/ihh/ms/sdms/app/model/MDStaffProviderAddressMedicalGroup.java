...
public class MDStaffProviderAddressMedicalGroup {
    ...
    @JsonProperty("Entity")
    private MDStaffProviderAddressMedicalGroupEntity entity;
    ...
    public MDStaffProviderAddressMedicalGroup() {
        // Empty Constructor
    }
    ...
    public MDStaffProviderAddressMedicalGroupEntity getEntity() {
        return entity;
    }

    public void setEntity(MDStaffProviderAddressMedicalGroupEntity entity) {
        this.entity = entity;
    }

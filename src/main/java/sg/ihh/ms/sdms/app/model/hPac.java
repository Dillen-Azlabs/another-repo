...
@JsonPropertyOrder({ "uid", "languageCode", "name", "address", "helplineTelephoneNumber", "telephoneNumbers", "email",
		"description", "repName", "repTelephoneNumber", "repEmail", "country", "qrCodeTitle1", "qrCodeImageUrl1",
		"qrCodeImageAltText1", "qrCodeTitle2", "qrCodeImageUrl2", "qrCodeImageAltText2", "order", "publishFlag",
